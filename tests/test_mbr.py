...
def test_mbr_nt5_with_whitelist(whitelist):
    ...
    dExpected = {
        ...
        'partition_table': [{'Number': 1, 'Attributes': 'Active', 'Type': 'NTFS',
                             'Start sector': 63, 'Size in sectors': 73368792}],
...
def test_mbr_nt60_with_whitelist(whitelist):
    ...
    dExpected = {
        ...
        'sample_name': sampleName,
        'partition_table': [{'Number': 1, 'Attributes': 'Active', 'Type': 'NTFS',
                             'Start sector': 2048, 'Size in sectors': 41938944}],
...
def test_mbr_nt61_with_whitelist(whitelist):
    ...
    dExpected = {
        ...
        'sample_name': sampleName,
        'partition_table': [{'Number': 1, 'Attributes': 'Active', 'Type': 'NTFS',
                             'Start sector': 2048, 'Size in sectors': 204800},
                            {'Number': 2, 'Attributes': 'Inactive', 'Type': 'NTFS',
                             'Start sector': 206848, 'Size in sectors': 40685568},
                            {'Number': 3, 'Attributes': 'Inactive', 'Type': 'NTFS',
                             'Start sector': 40892416, 'Size in sectors': 1046528},
                            ],
...
def test_mbr_uefi_with_whitelist(whitelist):
    ...
    dExpected = {
        'record_type': 'MBR',
        'sample_name': sampleName,
        'partition_table': [{'Number': 1, 'Attributes': 'Inactive', 'Type': 'PROTECTIVE_MBR',
                             'Start sector': 1, 'Size in sectors': 41943039}],
